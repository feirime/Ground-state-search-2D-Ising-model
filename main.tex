...
Рассмотрим одномерную цепочку такой модели из трёх спинов. Обозначим $\beta = \frac{1}{kT}$. Примем обменные интегралы $J$ везде равными единице. Статистическая сумма принимает вид:
