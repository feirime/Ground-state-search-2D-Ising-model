...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		...
		\begin{minipage}{0.3\textwidth}
			\resizebox{50px}{50px}{\includegraphics{1_Type1_1.eps}}
			\label{fig:Type1_1}
		\end{minipage}
		\hspace{20pt}
		\begin{minipage}{0.3\textwidth}
			\resizebox{50px}{50px}{\includegraphics{1_Type1_2.eps}}
			\label{fig:Type1_2}
		\end{minipage}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\begin{minipage}{0.3\textwidth}
			\resizebox{50px}{50px}{\includegraphics{1_Type2_1.eps}}
			\label{fig:Type2_1}
		\end{minipage}
		\hspace{20pt}
		\begin{minipage}{0.3\textwidth}
			\resizebox{50px}{50px}{\includegraphics{1_Type2_2.eps}}
			\label{fig:Type2_2}
		\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{50px}{50px}{\includegraphics{1_Type3_1.eps}}
		\label{fig:Type3_1}
	\end{minipage}
	\hspace{-40pt} 
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{50px}{50px}{\includegraphics{1_Type3_2.eps}}
		\label{fig:Type3_2}
	\end{minipage}
...
\begin{figure}[H]
	\centering
	\resizebox{100px}{70px}{\includegraphics{1_Type2_5x4.eps}}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{100px}{50px}{\includegraphics{1_Cl_Type2_gs1.eps}}
		\label{fig:cluster_gs1}
	\end{minipage}
	\hspace{20pt} 
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{100px}{50px}{\includegraphics{1_Cl_Type2_gs2.eps}}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{70px}{70px}{\includegraphics{1_Cl2x2_Type2_gs1.eps}}
		\label{fig:3x3_gs1}
	\end{minipage}
	\hspace{1pt} 
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{70px}{70px}{\includegraphics{1_Cl2x2_Type2_gs2.eps}}
		\label{fig:3x3_gs2}
	\end{minipage}
	\caption{Кластер, состоящий из трёх плакетов 2-го типа}
	\label{fig:3x3}
...
\begin{figure}[H]
	\centering
	\resizebox{100px}{70px}{\includegraphics{1_Cl4_Type2.eps}}
...
\begin{figure}[H]
	\centering
	\resizebox{150px}{75px}{\includegraphics{1_Cl7x4_Type2.eps}}
...
\begin{figure}[H]
	\centering
	\resizebox{400px}{200px}{\includegraphics{Egs_N_F.eps}}
...
\begin{figure}[H]
	\centering
	\resizebox{400px}{200px}{\includegraphics{Egs_N_N.eps}}
