...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{minipage}[t]{0.3\textwidth}
			...
			\caption{Two systems from Type-II plaquette (\textcolor{red}{$P_+=0.75, P_+=0.25$}).}
			\label{fig:Type2}
		\end{minipage}
		\hspace{5pt}
		\begin{minipage}[t]{0.3\textwidth}
	...
	\begin{figure}[H]
		...
		\end{minipage}
		\caption{The ground state configurations of the system (a, b, c, d: \textcolor{red}{  $P_+\approx0.58$}).}
		\label{fig:4x4.1}
	...
	\begin{figure}[H]
		...
		\caption{The ground state configuration of the system with two Type-II plaquettes (\textcolor{red}{  $P_+=0.6$}).}
		\label{fig:4x7}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\end{minipage}
		\caption{Ground state configurations of the system with two Type-II plaquettes (\textcolor{red}{  $P_+\approx0.58$}).}
		\label{fig:5x5.22F}
	\end{figure}
	
	Thus Type-II plaquettes are the only cause of frustrations in configurations of the ground state. In the ground state, frustrations are located between Type-II plaquettes or between a plaquette and the edge of the grid, depending on the distances. Macroscopic degeneration of the ground state is due to alternative frustration locations.
