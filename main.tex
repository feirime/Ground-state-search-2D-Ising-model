...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type1_1.eps}}
		\hspace{-4pt} 
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type1_2.eps}}
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type2_1.eps}}
		\hspace{-2pt} 
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type2_2.eps}}
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type3_1.eps}}
		\hspace{-4pt} 
		\resizebox{45px}{45px}{\includegraphics{pictures/1_Type3_2.eps}}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{90px}{60px}{\includegraphics{pictures/1_Type2_3x2.eps}}
		\label{fig:Type2_3x2}
	\end{minipage}
	\hspace{20pt} 
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{90px}{60px}{\includegraphics{pictures/1_Type2_3x2_2.eps}}
...
Во введении приведена таблица \ref{tab:Egs} со значениями энергии основного состояния спинового стекла. Мы создали несколько образцов спинового льда, один из них на рисунке (\ref{fig:cell_SI_SG_64}) слева. Вычисления показывают, что энергия основного состояния на один спин при $P_+ = 0.5$ и отсутствии воздействия внешнего магнитного поля составила -1.75, при этом удельная энергия основного состояния спинового стекла в модели Эдвардса-Андерсона составила -1.28. Под спиновым льдом обычно понимается магнетики с периодичностью в обменных взаимодействиях \cite{peretyatko2017interplay, otsuka2018husimi, andriushchenko2019large, shevchenko2017effect, kato2022flux}. 
