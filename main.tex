...
\begin{document}
	...
	The partition function for a chain of 3 spins with open boundary conditions is given by (all interactions is ferromagnetic $J = 1$):
	\textcolor{red}{
	\begin{equation}
	...
	\textcolor{red}{For the same P+ = 0.5 with the random distribution of ferromagnetic-antiferromagnetic interactions of Figure \ref{fig:cell_SI_SG_64}(b), we observe 15 frustrations. So the energy will be equal to $E = -112 + 15\times2 = -82$, which coincides with the results of the complete enumeration.}
