...
External magnetic field shifts phase boundaries. For $h/J > 1$, a spin-flop transition occurs in some samples, and for $h/J > 2$, it occurs in all. At $h/J > 4$, all samples transition to a ferromagnetic state.
