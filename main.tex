...
\begin{figure}[H]
	...
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{110px}{70px}{\includegraphics{pictures/1_Type2_3x2.eps}}
		\label{fig:Type2_3x2}
	\end{minipage}
	\hspace{20pt} 
	\begin{minipage}{0.3\textwidth}
		\centering
		\resizebox{110px}{70px}{\includegraphics{pictures/1_Type2_3x2_2.eps}}
...
Если в системе два не пересекающиеся плакета 2-го типа \ref{fig:4x7} ($E_{gs}=-33$, $M_{gs}=0$), то возможна такая ситуация, что им энергетически выгоднее возбуждать плакеты по направлению друг к другу, а не к краю решётки.
