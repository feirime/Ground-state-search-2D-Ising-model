...
\begin{document}
	...
	\begin{figure}[H]
		...
		\begin{minipage}[t]{0.3\textwidth}
			...
			\caption{Type-I plaquettes (\textcolor{red}{  $P_+=0.5$})\textcolor{red}{.}}
			\label{fig:Type1} 
		\end{minipage}
		\hspace{5pt} 
		\begin{minipage}[t]{0.3\textwidth}
			...
			\caption{Type-II plaquettes (\textcolor{red}{$P_+=0.75, P_+=0.25$})\textcolor{red}{.}}
			\label{fig:Type2}
		\end{minipage}
		\hspace{5pt}
		\begin{minipage}[t]{0.3\textwidth}
			...
			\caption{Type-III plaquettes (\textcolor{red}{  $P_+=1.0, P_+=0.0$ })\textcolor{red}{.}}
			\label{fig:Type3}
		\end{minipage}
	\end{figure}
